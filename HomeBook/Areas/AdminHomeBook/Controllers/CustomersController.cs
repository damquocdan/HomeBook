...
namespace HomeBook.Areas.AdminHomeBook.Controllers
{
    ...
    public class CustomersController : Controller
    {
        ...
        public CustomersController(HomeBookContext context)
        {
            _context = context;
        }

        // GET: AdminHomeBook/Customers
        public async Task<IActionResult> Index()
        {
            return View(await _context.Customers.ToListAsync());
        }

        // GET: AdminHomeBook/Customers/Details/5
        ...
        // GET: AdminHomeBook/Customers/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: AdminHomeBook/Customers/Create
        ...
        // GET: AdminHomeBook/Customers/Edit/5
        ...
        // POST: AdminHomeBook/Customers/Edit/5
        // To protect from overposting attacks, enable the specific properties you want to bind to.
        // For more details, see http://go.microsoft.com/fwlink/?LinkId=317598.
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: AdminHomeBook/Customers/Delete/5
        ...
        // POST: AdminHomeBook/Customers/Delete/5
